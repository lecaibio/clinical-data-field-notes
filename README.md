...
| 03 | A trial's analysis columns are answers to the question that trial asked | The primary-endpoint table rebuilds exactly from the shipped data, and getting there is what shows which of the trial's decisions a different question can inherit | [Before Modelling Clinical Trial Data, Rebuild Its Primary Endpoint](https://lecaibio.github.io/2026/08/16/clinical-trial-data-rebuild-the-primary-endpoint.html) | [notebook](03-adam-traceability/notebook.ipynb) |
